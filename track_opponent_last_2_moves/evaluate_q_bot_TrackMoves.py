...
from track_opponent_last_2_moves.QLearningBotTrackMoves import QLearningBotTrackMoves
...
DEFAULT_CHECKPOINT = (
        ...
        / "checkpoints"
        / "q_learning_bot_track_moves.pt"
)

RESULTS_FILE = (
        Path(__file__).resolve().parent
        / "results"
        / "evaluation_results_track_moves.txt"
)
...
class evaluate_learning_bot:
    ...
    def load_learning_bot(self):
        ...
        learning_bot = QLearningBotTrackMoves()
    ...
    def write_results(
        ...
        if completed_games == 0:
            ...
            win_rate1 = P1_wins / ceil(completed_games/2) * 100
            win_rate2 = P2_wins / floor(completed_games/2) * 100
        ...
        result = (
            ...
            f"Win rate as P1: {win_rate1:.1f}%\n"
            f"Win rate as P2: {win_rate2:.1f}%\n"
