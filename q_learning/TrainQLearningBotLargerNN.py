...
from q_learning.QLearningBotLargerNN import (
    QLearningBotLargerNN,
    QNetwork,
)
...
class TrainQLearningBotLargerNN:
    def __init__(self, epsilon: float):
        self.bot = QLearningBotLargerNN(epsilon)
...
if __name__ == "__main__":
    epsilon = 0.20
    trainer = TrainQLearningBotLargerNN(epsilon)
